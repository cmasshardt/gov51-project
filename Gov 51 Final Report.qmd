...
\
Now, putting these pieces together, we can see the relationship between per-pupil spending and student proficiency over this time period. Overall, we see a negative relationship between per-pupil spending and student proficiency rates over this period. For Algebra, the correlation coefficient (r) for the relationship is -0.78, which indicates a strong correlation, but is impacted by pandemic-related outliers. The coefficient of -0.0043 on per-pupil spending (tot_current_per_adm) in the regression with Algebra proficiency rates is statistically significant at the 0.05 level, but is likewise influenced by Covid outliers. For English, the coefficient is not statistically significant.
